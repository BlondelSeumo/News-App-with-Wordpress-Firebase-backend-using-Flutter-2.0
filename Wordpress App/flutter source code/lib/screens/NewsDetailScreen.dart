      ...
      child: Scaffold(
        appBar: (getIntAsync(DETAIL_PAGE_VARIANT, defaultValue: 1) == 1 && widget.newsData != null)
            ? appBarWidget(
                ...
                showBack: true,
                color: getIntAsync(DASHBOARD_PAGE_VARIANT, defaultValue: 1) != 1 ? Theme.of(context).cardColor : getAppPrimaryColor(),
                ...
                actions: [
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      showInDialog(
                        context,
                        builder: (context) => ReadAloudDialog(parseHtmlString(postContent)),
